      ...
      <div className="max-w-xl mx-auto mb-8">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-20 py-3 bg-black/20 border border-white/10 rounded-lg text-foreground placeholder:text-muted-foreground font-mono text-sm focus:outline-none focus:ring-1 focus:ring-neon-purple/50 focus:border-neon-purple/50 transition-all"
          />
