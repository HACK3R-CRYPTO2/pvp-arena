...
export function OrdersList({ botAddress, botLabel }: OrdersListProps) {
  ...
  return (
    <div className="w-full">
      {/* Header - Hidden or simplified since parent has title */}
      ...
      <div className="divide-y divide-border">
        {loading ? (
          ...
          activeOrders.slice(0, 10).map((order) => {
            ...
            return (
              <div key={order.orderId} className="px-2 py-3 hover:bg-white/5 transition-colors cursor-default rounded border-b border-white/5 last:border-0">
